...
```
cd existing_repo
git remote add origin http://gitlab.main-server.sova.local/sova/webhook_manager.git
git branch -M master
...
- [ ] [Set up project integrations](http://gitlab.main-server.sova.local/sova/webhook_manager/-/settings/integrations)
